...
def can_be_found_updated_and_saved
  ...
  movieToUpdate = Movie.find_by(title: "Awesome Flick")
  movieToUpdate.title = "Even Awesomer Flick"
  movieToUpdate.save
end
...
def can_update_using_update_method
  ...
  movieToUpdate = Movie.find_by(title: "Wat?")
  movieToUpdate.update(title: "Wat, huh?")
end
